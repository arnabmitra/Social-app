...
fb.views.PostUI = Backbone.View.extend({
    ...
    postMessage: function () {
        FB.ui(
            {
                method:'feed',
                name:'PricePop Application',
                link:'http://www.devswag.com/',
                picture:'http://cdn.shopify.com/s/files/1/0154/2777/products/handlebars-detail_1_1024x1024.jpg?34',
                caption:'by Scooby Doo',
                description:'Price is a test app'
            },
            function (response) {
                if (response && response.id) {
                    alert('Your post was published.');
